...
$title = Yii::t('yii', 'Update Occasion');
?>
<div class="occasion-create">
    ...
    <?=$form->field($model, 'str_start_time')->widget(DateTimePicker::classname(), 
        [
            'options' => ['placeholder' => Yii::t('yii', date('Y-m-d H:i', $model->occasion->start_time))],
            'convertFormat' => true,
            'pluginOptions' => [
                'autoclose' => true,
    ...
    <?=$form->field($model, 'str_end_time')->widget(DateTimePicker::classname(), 
        [
            'options' => ['placeholder' => Yii::t('yii', date('Y-m-d H:i', $model->occasion->end_time))],
            'convertFormat' => true,
            'pluginOptions' => [
                'autoclose' => true,
                'format' => 'yyyy-MM-dd HH:i',
